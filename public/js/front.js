...
module.exports = {
    ...
    methods: {
        ...
        fetchCartList: function fetchCartList() {
            this.$http.get('/cart/index').then(function (res) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-9c244a3a", module.exports)
  } else {
...
module.exports = {
    ...
    methods: {
        fetchCartInfo: function fetchCartInfo(shouldFlash) {
            var _this = this;

            this.$http.get('/cart/summary').then(function (res) {
                return _this.updateCartData(res.data, shouldFlash);
            }).catch(function () {
                return console.log('unable to get cart summary');
            });
        },
        updateCartData: function updateCartData(data, shouldFlash) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-47217c89", module.exports)
  } else {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-429a74d5", module.exports)
  } else {
...
module.exports = {
    ...
    methods: {
        editQuantity: function editQuantity() {
            ...
            this.saving = true;
            this.$http.patch('/cart/update', { id: this.productId, quantity: this.quantity }).then(function (res) {
                return _this.onSuccessfullUpdate(res.data);
            }).catch(function () {
                return _this.onUpdateFailure();
            });
        },
        onSuccessfullUpdate: function onSuccessfullUpdate(responseData) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6c4276f6", module.exports)
  } else {
...
new Vue({
    ...
    events: {
        ...
        'message': function message(alert) {
            swal({
                type: alert.type,
                title: alert.title,
                text: alert.text,
...
},{"./components/Cart.vue":14,"./components/Cartalert.vue":15,"./components/Cartbutton.vue":16,"./components/Cartitem.vue":17,"./components/Contactform.vue":18,"./components/Productgallery.vue":19,"./components/Slider.vue":20,"sweetalert":10,"vue":13,"vue-resource":12}]},{},[21]);
